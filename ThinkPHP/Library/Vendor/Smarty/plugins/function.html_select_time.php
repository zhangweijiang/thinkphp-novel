 ...
 *
 * @package Smarty
 * @subpackage __PUBLIC__/Pc/pluginsFunction
 */

/**
 * @ignore
 */
require_once(SMARTY___PUBLIC__/Pc/plugins_DIR . 'shared.escape_special_chars.php');
/**
 * @ignore
 */
require_once(SMARTY___PUBLIC__/Pc/plugins_DIR . 'shared.make_timestamp.php');
