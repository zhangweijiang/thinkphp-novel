 ...
 * Smarty Resource Plugin
 *
 * Base implementation for resource __PUBLIC__/Pc/plugins
 *
 * @package Smarty
 * @subpackage TemplateResources
 */
abstract class Smarty_Resource {
     ...
     * @var array
     */
    protected static $sys__PUBLIC__/Pc/plugins = array(
        'file' => true,
        'string' => true,
        'extends' => true,
        'stream' => true,
    ...
    public static function load(Smarty $smarty, $type)
    {
        ...
        // try sys__PUBLIC__/Pc/plugins dir
        if (isset(self::$sys__PUBLIC__/Pc/plugins[$type])) {
