...
class PHPExcel_Calculation_Financial {
	 ...
	 * the calculation depending on the life of the Admin.
	 * This function will return the depreciation until the last period of the life of the Admin
	 * or until the cumulated value of depreciation is greater than the cost of the Admin minus
	 * the salvage value.
	 *
	 * Excel Function:
	...
	public static function AMORDEGRC($cost, $purchased, $firstPeriod, $salvage, $period, $rate, $basis=0) {
		...
		//	Life of Admin (1/rate)		Depreciation coefficient
		//	Less than 3 years			1
